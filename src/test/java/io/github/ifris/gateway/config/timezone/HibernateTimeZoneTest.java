package io.github.ifris.gateway.config.timezone;

import io.github.ifris.gateway.IfrisGatewayApp;
import io.github.ifris.gateway.config.SecurityBeanOverrideConfiguration;
import io.github.ifris.gateway.repository.timezone.DateTimeWrapper;
import io.github.ifris.gateway.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, IfrisGatewayApp.class})
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ifris_date_time_wrapper where id=%d", fieldName, id);
    }
