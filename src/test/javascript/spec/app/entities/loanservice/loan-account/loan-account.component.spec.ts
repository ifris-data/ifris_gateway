...
import { LoanAccountComponent } from 'app/entities/loanservice/loan-account/loan-account.component';
...
describe('Component Tests', () => {
    describe('LoanAccount Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.loanAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
